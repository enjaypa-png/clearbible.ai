...
export const metadata = {
  title: "Sermon Outline Generator - Free Bible Tool | ClearBible.ai",
  description: "Get a structured sermon outline for any Bible passage. Perfect for pastors, small group leaders, or personal study.",
};
      ...
      <section className="marketing-section" style={{ background: "linear-gradient(180deg, #fff 0%, #f5f2ff 100%)", textAlign: "center" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <h1 style={{ fontSize: "clamp(32px, 5vw, 48px)", fontWeight: 800, color: "#1a1510", marginBottom: 24 }}>
            Sermon Outline <span className="gradient-text">Generator</span>
          </h1>
          <p style={{ fontSize: 18, lineHeight: 1.7, color: "#5a554e", marginBottom: 40 }}>
            Get a structured outline for any Bible passage. Perfect for pastors, small group leaders, or personal study.
          </p>

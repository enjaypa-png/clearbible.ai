...
export const metadata = {
  title: "Bible Reading Time Calculator - Free Bible Tool | ClearBible.ai",
  description: "Find out how long it takes to read any book of the Bible. Plan your reading schedule with this free calculator.",
};

export default function BibleReadingTimeCalculatorPage() {
  return (
      ...
      <section className="marketing-section" style={{ background: "linear-gradient(180deg, #fff 0%, #f5f2ff 100%)", textAlign: "center" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <h1 style={{ fontSize: "clamp(32px, 5vw, 48px)", fontWeight: 800, color: "#1a1510", marginBottom: 24 }}>
            Bible Reading Time <span className="gradient-text">Calculator</span>
          </h1>
          <p style={{ fontSize: 18, lineHeight: 1.7, color: "#5a554e", marginBottom: 40 }}>
            Find out how long it takes to read any book, chapter, or the entire Bible. Plan your reading schedule effectively.
          </p>
          <div className="marketing-card" style={{ maxWidth: 500, margin: "0 auto", textAlign: "center", padding: 48 }}>
            <p style={{ fontSize: 16, color: "#6a655e", marginBottom: 24 }}>
              This tool is coming soon. In the meantime, start reading the Bible in ClearBible.
            </p>
